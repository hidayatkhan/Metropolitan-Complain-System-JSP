  ...
  <div class="row" id="pwd-container">
    ...
    <div class="col-md-4" style="margin-top: 100px">
      <section class="login-form">
          ...
          <div style="margin-top: 0px"><p id="txt" class="lead">Last Step For the Registration</p></div>
          <input type="password" class="form-control input-lg" id="code" required=""placeholder="Enter Pin Code to Verify Login" required />
          
          <button type="button"  //onclick="Ajaxvalidate(3)" name="go" class="btn btn-lg btn-primary btn-block"// >Done</button>
